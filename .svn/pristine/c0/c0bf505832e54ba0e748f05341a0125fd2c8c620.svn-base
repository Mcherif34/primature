...
@Controller
@RequestMapping(value = "/demande_audience")
public class DemandeAudienceController {

	private static final Logger log = LoggerFactory.getLogger(DemandeAudienceController.class);
	...
	public ModelAndView login(Model model, HttpServletResponse response) {
		ModelAndView modelAndView = new ModelAndView("client/demandeAudienceList");
