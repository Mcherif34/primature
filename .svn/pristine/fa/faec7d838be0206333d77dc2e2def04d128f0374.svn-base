app.controller('parcelleController', function($scope, $http, $ngBootbox, $location, CRUDService, NotificationService, constants) {
	...
	$scope.baseUrl = "/investissement/parcelle/rest/";
...
app.controller('parcelleTableController', function($scope,$http) {
	$scope.init = function() {
		var columns = [ 
		...
		$scope.$parent.table = TableManager.init("parcelleTable", $scope.$parent.baseUrl+"list", columns);
