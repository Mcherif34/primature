...
@Controller
@RequestMapping(value = "/demande_titularisation")
public class DemandeTitularisationController {
	...
	public ModelAndView login(Model model, HttpServletResponse response) {
		ModelAndView modelAndView = new ModelAndView("client/demandeTitularisationList");
