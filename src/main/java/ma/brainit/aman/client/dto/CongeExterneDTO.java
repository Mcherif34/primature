...
public class CongeExterneDTO extends CongeExterne {
    ...
    @Override
    @View(attribut="referenceDemande")
    public String getReferenceDemande() {
        return super.getReferenceDemande();
    }
	...
	@JsonSerialize(using=JsonDateSerializer.class)
	@JsonDeserialize(using=JsonDateDeserializer.class)
	@View(attribut = "dateDebutConge")
	public Date getDateDebutConge() {
		return super.getDateDebutConge();
	}
    
    @Override
	@JsonSerialize(using=JsonDateSerializer.class)
	@JsonDeserialize(using=JsonDateDeserializer.class)
	@View(attribut = "dateFinConge")
	public Date getDateFinConge() {
		return super.getDateFinConge();
	}
    ...
    @Override
    @View(attribut="traitementRh")
    public String getTraitementRh() {
        return super.getTraitementRh();
    }
    ...
    @Override
    @View(attribut="transfertRh")
    public String getTransfertRh() {
        return super.getTransfertRh();
    }
    ...
    @Override
    @View(attribut="rejetTraitementRh")
    public String getRejetTraitementRh() {
        return super.getRejetTraitementRh();
    }
    ...
    @Override
    @View(attribut="motifRejetTraitementRh")
    public String getMotifRejetTraitementRh() {
        return super.getMotifRejetTraitementRh();
    }
    ...
    @Override
    @View(attribut="motifRejetTransfertRh")
    public String getMotifRejetTransfertRh() {
        return super.getMotifRejetTransfertRh();
    }
