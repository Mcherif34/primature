...
public class MaterielDTO extends Materiel {
    ...
    @Override
    @View(attribut="referenceBc")
    public String getReferenceBc() {
        return super.getReferenceBc();
    }
    ...
    @Override
    @View(attribut="visaDaaf")
    public String getVisaDaaf() {
        return super.getVisaDaaf();
    }
    
    @Override
    @View(attribut="traitementSm")
    public String getTraitementSm() {
        return super.getTraitementSm();
    }
    ...
    @Override
    @View(attribut="rejetVisaDaaf")
    public String getRejetVisaDaaf() {
        return super.getRejetVisaDaaf();
    }
    
    @Override
    @View(attribut="motifRejetVisaDaaf")
    public String getMotifRejetVisaDaaf() {
        return super.getMotifRejetVisaDaaf();
    }
    
    @Override
    @View(attribut="motifRejetTraitementSm")
    public String getMotifRejetTraitementSm() {
        return super.getMotifRejetTraitementSm();
    }
