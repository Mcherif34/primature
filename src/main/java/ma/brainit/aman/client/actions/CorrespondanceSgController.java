...
@Controller
@RequestMapping(value = "/correspondancesg")
public class CorrespondanceSgController {

	private static final Logger log = LoggerFactory.getLogger(CorrespondanceSgController.class);
	
	@Autowired
	private CorrespondanceSgService CorrespondanceService;
	...
	public ModelAndView login(Model model, HttpServletResponse response) {
		ModelAndView modelAndView = new ModelAndView("client/correspondanceSgList");
	...
	public @ResponseBody ResponseEntity<String> getCorrespondanceDashboardPage(
			@RequestParam("page") Optional<Integer> page,
			@RequestParam("limit") Optional<Integer> limit,
			@RequestParam("sort") Optional<String> sort,
			@RequestParam("direction") Optional<String> direction,
			@RequestParam("search") Optional<String> search){
		String result = CorrespondanceService.getCurrentPageDashboard(page.orElse(0),limit.orElse(null),sort.orElse(null),direction.orElse(null),search.orElse(null));
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	
	@RequestMapping(value="/rest/currentList", method=RequestMethod.GET)
	public @ResponseBody ResponseEntity<String> getCorrespondancePage(
			@RequestParam("page") Optional<Integer> page,
			@RequestParam("limit") Optional<Integer> limit,
			@RequestParam("sort") Optional<String> sort,
			@RequestParam("direction") Optional<String> direction,
			@RequestParam("search") Optional<String> search){
		String result = CorrespondanceService.getCurrentPage(page.orElse(0),limit.orElse(null),sort.orElse(null),direction.orElse(null),search.orElse(null));
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	
	@RequestMapping(value="/rest/doneList", method=RequestMethod.GET)
	public @ResponseBody ResponseEntity<String> getDoneCorrespondancePage(
			@RequestParam("page") Optional<Integer> page,
			@RequestParam("limit") Optional<Integer> limit,
			@RequestParam("sort") Optional<String> sort,
			@RequestParam("direction") Optional<String> direction,
			@RequestParam("search") Optional<String> search){
		String result = CorrespondanceService.getDonePage(page.orElse(0),limit.orElse(null),sort.orElse(null),direction.orElse(null),search.orElse(null));
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	
	@RequestMapping(value="/rest/closeList", method=RequestMethod.GET)
	public @ResponseBody ResponseEntity<String> getCloseCorrespondancePage(
			@RequestParam("page") Optional<Integer> page,
			@RequestParam("limit") Optional<Integer> limit,
			@RequestParam("sort") Optional<String> sort,
			@RequestParam("direction") Optional<String> direction,
			@RequestParam("search") Optional<String> search){
		String result = CorrespondanceService.getClosePage(page.orElse(0),limit.orElse(null),sort.orElse(null),direction.orElse(null),search.orElse(null));
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	...
	public @ResponseBody ResponseEntity<String> advancedSearch(
		...
		String result = CorrespondanceService.advancedSearch(page.orElse(0),limit.orElse(null),sort.orElse(null),direction.orElse(null),search.orElse(null), referenceCourrier, receptionDateStart, receptionDateEnd, referenceExpediteur, enregistrementDateStart, enregistrementDateEnd, expediteur, objet, status);
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	...
	public @ResponseBody String load(@PathVariable("id") Long id){
		CorrespondanceSgDTO dto =  CorrespondanceService.load(id);
	...
	public @ResponseBody String loadByReference(@PathVariable("reference") String reference){
		CorrespondanceSgDTO dto =  CorrespondanceService.loadByReference(reference);
		return Util.toJson(dto);
	}
	...
	public @ResponseBody String loadDocumentsByReference(@PathVariable("reference") String reference){
		List<DocumentDTO> list =  CorrespondanceService.loadDocumentsByReference(reference);
		return Util.toJson(list);
	}
	
	@RequestMapping(value="/rest/save", method=RequestMethod.POST )
	public @ResponseBody String save(@ModelAttribute CorrespondanceSgDTO dto) {
		String result = CorrespondanceService.save(dto);
		return Util.toJson(result);
	}
	
	@RequestMapping(value="/rest/send", method=RequestMethod.POST )
	public @ResponseBody String send(@ModelAttribute CorrespondanceSgDTO dto){
		CorrespondanceSgDTO correspondanceDTO = CorrespondanceService.loadByVolumeId(dto.getwSubWorkId());
		correspondanceDTO.setDocuments(dto.getDocuments());
		if(dto.getConseillerTechnique() != null)
			correspondanceDTO.setConseillerTechnique(dto.getConseillerTechnique());
		if(dto.getTransfereAu() != null)
			correspondanceDTO.setTransfereAu(dto.getTransfereAu());
		correspondanceDTO.setMotif(dto.getMotif());
		String result = CorrespondanceService.send(correspondanceDTO);
		return Util.toJson(result);
	}
	
	@RequestMapping(value="/rest/delete", method=RequestMethod.POST )
	public @ResponseBody String remove(@RequestBody Long id){
		String result = CorrespondanceService.delete(id);
		return Util.toJson(result);
	}
	
	@RequestMapping(value="/rest/getAll", method=RequestMethod.GET)
	public @ResponseBody String getAll(){
		return Util.toJson(CorrespondanceService.getAll());
	}
	...
	public @ResponseBody String getCurrentCountByEntity(@PathVariable("term") String term){
		return Util.toJson(CorrespondanceService.getCurrentCountByEntity(term));
	}
	
	@RequestMapping(value="/rest/getCurrentCount", method=RequestMethod.GET)
	public @ResponseBody String getCurrentCount(){
		return Util.toJson(CorrespondanceService.getCurrentCount());
	}
	...
	public @ResponseBody String getCurrentCountByProfile(){
		return Util.toJson(CorrespondanceService.getCurrentCountByProfile());
	}
	...
	public @ResponseBody String getCurrentCountByYear(@PathVariable("year") int year){
		return Util.toJson(CorrespondanceService.getCurrentCountByYear(year));
	}
	...
	public @ResponseBody String getCurrentNotOverdueInvoiceCount(){
		return Util.toJson(CorrespondanceService.getCurrentNotOverdueClassiqueCount());
	}
	...
	public @ResponseBody String getCurrentOverdueInvoiceCount(){
		return Util.toJson(CorrespondanceService.getCurrentOverdueClassiqueCount());
	}
	...
	public @ResponseBody String getCompletedClassiqueCount(){
		return Util.toJson(CorrespondanceService.getCompletedClassiqueCount());
	}
	...
	public @ResponseBody String getCompletedCountByYear(@PathVariable("year") int year){
		return Util.toJson(CorrespondanceService.getCompletedCountByYear(year));
	}
	...
	public void exportXMLDeclaration(HttpServletResponse response, @PathVariable("dataId") long dataId) throws ParserConfigurationException {
		CorrespondanceService.downloadAttachment(dataId, response);
	}
	...
	public @ResponseBody ResponseEntity<byte[]> streamDocument(@PathVariable("dataId") long dataId) {
		return CorrespondanceService.streamDocument(dataId);
	}
