...
@Controller
@RequestMapping(value = "/autorisation_absence")
public class AutorisationAbsenceController {

	private static final Logger log = LoggerFactory.getLogger(AutorisationAbsenceController.class);
	
	/*@Autowired
	private CourrierClassiqueService CourrierClassiqueService;
	...
	public ModelAndView login(Model model, HttpServletResponse response) {
		ModelAndView modelAndView = new ModelAndView("client/autorisationAbsenceList");
