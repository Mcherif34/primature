...
@Controller
@RequestMapping(value = "/correspondancedircab")
public class CorrespondanceDircabController {

	private static final Logger log = LoggerFactory.getLogger(CorrespondanceDircabController.class);
	
	@Autowired
	private CorrespondanceDircabService CorrespondanceService;
	...
	public ModelAndView login(Model model, HttpServletResponse response) {
		ModelAndView modelAndView = new ModelAndView("client/correspondanceDircabList");
	...
	public @ResponseBody String load(@PathVariable("id") Long id){
		CorrespondanceDircabDTO dto =  CorrespondanceService.load(id);
	...
	public @ResponseBody String loadByReference(@PathVariable("reference") String reference){
		CorrespondanceDircabDTO dto =  CorrespondanceService.loadByReference(reference);
		return Util.toJson(dto);
	}
	...
	public @ResponseBody String save(@ModelAttribute CorrespondanceDircabDTO dto) {
	...
	public @ResponseBody String send(@ModelAttribute CorrespondanceDircabDTO dto){
		CorrespondanceDircabDTO correspondanceDTO = CorrespondanceService.loadByVolumeId(dto.getwSubWorkId());
