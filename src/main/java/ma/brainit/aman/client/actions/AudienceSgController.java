...
@Controller
@RequestMapping(value = "/audiencesg")
public class AudienceSgController {

	private static final Logger log = LoggerFactory.getLogger(AudienceSgController.class);
	
	@Autowired
	private AudienceSgService AudienceService;
	...
	public ModelAndView login(Model model, HttpServletResponse response) {
		ModelAndView modelAndView = new ModelAndView("client/audienceSgList");
	...
	public @ResponseBody ResponseEntity<String> getAudienceDashboardPage(
			@RequestParam("page") Optional<Integer> page,
			@RequestParam("limit") Optional<Integer> limit,
			@RequestParam("sort") Optional<String> sort,
			@RequestParam("direction") Optional<String> direction,
			@RequestParam("search") Optional<String> search){
		String result = AudienceService.getCurrentPageDashboard(page.orElse(0),limit.orElse(null),sort.orElse(null),direction.orElse(null),search.orElse(null));
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	
	@RequestMapping(value="/rest/currentList", method=RequestMethod.GET)
	public @ResponseBody ResponseEntity<String> getAudiencePage(
			@RequestParam("page") Optional<Integer> page,
			@RequestParam("limit") Optional<Integer> limit,
			@RequestParam("sort") Optional<String> sort,
			@RequestParam("direction") Optional<String> direction,
			@RequestParam("search") Optional<String> search){
		String result = AudienceService.getCurrentPage(page.orElse(0),limit.orElse(null),sort.orElse(null),direction.orElse(null),search.orElse(null));
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	
	@RequestMapping(value="/rest/doneList", method=RequestMethod.GET)
	public @ResponseBody ResponseEntity<String> getDoneAudiencePage(
			@RequestParam("page") Optional<Integer> page,
			@RequestParam("limit") Optional<Integer> limit,
			@RequestParam("sort") Optional<String> sort,
			@RequestParam("direction") Optional<String> direction,
			@RequestParam("search") Optional<String> search){
		String result = AudienceService.getDonePage(page.orElse(0),limit.orElse(null),sort.orElse(null),direction.orElse(null),search.orElse(null));
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	
	@RequestMapping(value="/rest/closeList", method=RequestMethod.GET)
	public @ResponseBody ResponseEntity<String> getCloseAudiencePage(
			@RequestParam("page") Optional<Integer> page,
			@RequestParam("limit") Optional<Integer> limit,
			@RequestParam("sort") Optional<String> sort,
			@RequestParam("direction") Optional<String> direction,
			@RequestParam("search") Optional<String> search){
		String result = AudienceService.getClosePage(page.orElse(0),limit.orElse(null),sort.orElse(null),direction.orElse(null),search.orElse(null));
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	...
	public @ResponseBody ResponseEntity<String> advancedSearch(
		...
		String result = AudienceService.advancedSearch(page.orElse(0),limit.orElse(null),sort.orElse(null),direction.orElse(null),search.orElse(null), referenceCourrier, receptionDateStart, receptionDateEnd, referenceExpediteur, enregistrementDateStart, enregistrementDateEnd, expediteur, objet, status);
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	...
	public @ResponseBody String load(@PathVariable("id") Long id){
		AudienceSgDTO dto =  AudienceService.load(id);
	...
	public @ResponseBody String loadByReference(@PathVariable("reference") String reference){
		AudienceSgDTO dto =  AudienceService.loadByReference(reference);
		return Util.toJson(dto);
	}
	...
	public @ResponseBody String loadDocumentsByReference(@PathVariable("reference") String reference){
		List<DocumentDTO> list =  AudienceService.loadDocumentsByReference(reference);
		return Util.toJson(list);
	}
	
	@RequestMapping(value="/rest/save", method=RequestMethod.POST )
	public @ResponseBody String save(@ModelAttribute AudienceSgDTO dto) {
		String result = AudienceService.save(dto);
		return Util.toJson(result);
	}
	
	@RequestMapping(value="/rest/send", method=RequestMethod.POST )
	public @ResponseBody String send(@ModelAttribute AudienceSgDTO dto){
		AudienceSgDTO audienceDTO = AudienceService.loadByVolumeId(dto.getwSubWorkId());
		audienceDTO.setDocuments(dto.getDocuments());
		if(dto.getConseillerTechnique() != null)
			audienceDTO.setConseillerTechnique(dto.getConseillerTechnique());
		audienceDTO.setMotif(dto.getMotif());
		String result = AudienceService.send(audienceDTO);
		return Util.toJson(result);
	}
	
	@RequestMapping(value="/rest/delete", method=RequestMethod.POST )
	public @ResponseBody String remove(@RequestBody Long id){
		String result = AudienceService.delete(id);
		return Util.toJson(result);
	}
	
	@RequestMapping(value="/rest/getAll", method=RequestMethod.GET)
	public @ResponseBody String getAll(){
		return Util.toJson(AudienceService.getAll());
	}
	...
	public @ResponseBody String getCurrentCountByEntity(@PathVariable("term") String term){
		return Util.toJson(AudienceService.getCurrentCountByEntity(term));
	}
	
	@RequestMapping(value="/rest/getCurrentCount", method=RequestMethod.GET)
	public @ResponseBody String getCurrentCount(){
		return Util.toJson(AudienceService.getCurrentCount());
	}
	...
	public @ResponseBody String getCurrentCountByProfile(){
		return Util.toJson(AudienceService.getCurrentCountByProfile());
	}
	...
	public @ResponseBody String getCurrentCountByYear(@PathVariable("year") int year){
		return Util.toJson(AudienceService.getCurrentCountByYear(year));
	}
	...
	public @ResponseBody String getCurrentNotOverdueInvoiceCount(){
		return Util.toJson(AudienceService.getCurrentNotOverdueClassiqueCount());
	}
	...
	public @ResponseBody String getCurrentOverdueInvoiceCount(){
		return Util.toJson(AudienceService.getCurrentOverdueClassiqueCount());
	}
	...
	public @ResponseBody String getCompletedClassiqueCount(){
		return Util.toJson(AudienceService.getCompletedClassiqueCount());
	}
	...
	public @ResponseBody String getCompletedCountByYear(@PathVariable("year") int year){
		return Util.toJson(AudienceService.getCompletedCountByYear(year));
	}
	...
	public void exportXMLDeclaration(HttpServletResponse response, @PathVariable("dataId") long dataId) throws ParserConfigurationException {
		AudienceService.downloadAttachment(dataId, response);
	}
	...
	public @ResponseBody ResponseEntity<byte[]> streamDocument(@PathVariable("dataId") long dataId) {
		return AudienceService.streamDocument(dataId);
	}
