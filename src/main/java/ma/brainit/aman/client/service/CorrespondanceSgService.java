...
public interface CorrespondanceSgService {
	...
	String save(CorrespondanceSgDTO dto);

	CorrespondanceSgDTO load(Long id);
	
	CorrespondanceSgDTO loadByVolumeId(Long volumeId);
	
	CorrespondanceSgDTO loadByReference(String reference);
	
	List<DocumentDTO> loadDocumentsByReference(String reference);
	
	String delete(Long id);
	
	String send(CorrespondanceSgDTO dto);
	
	List<CorrespondanceSgDTO> getAll();
