...
public interface NominationService {
	...
	String advancedSearch(Integer page, Integer limit, String sort, String direction, String search, String referenceCourrier, String referenceNomination, String enregistrementDateStart, String enregistrementDateEnd, String objet, String status);
	
	String save(NominationDTO dto);

	NominationDTO load(Long id);
	
	NominationDTO loadByVolumeId(Long volumeId);
	
	NominationDTO loadByReference(String reference);
	
	List<DocumentDTO> loadDocumentsByReference(String reference);
	
	String delete(Long id);
	
	String send(NominationDTO dto);
