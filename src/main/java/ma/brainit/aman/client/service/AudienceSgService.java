...
public interface AudienceSgService {
	...
	String save(AudienceSgDTO dto);

	AudienceSgDTO load(Long id);
	
	AudienceSgDTO loadByVolumeId(Long volumeId);
	
	AudienceSgDTO loadByReference(String reference);
	
	List<DocumentDTO> loadDocumentsByReference(String reference);
	
	String delete(Long id);
	
	String send(AudienceSgDTO dto);
	
	List<AudienceSgDTO> getAll();
