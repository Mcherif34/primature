...
public interface TitularisationService {
	...
	String save(TitularisationDTO dto);

	TitularisationDTO load(Long id);
	
	TitularisationDTO loadByVolumeId(Long volumeId);
	
	TitularisationDTO loadByReference(String reference);
	
	List<DocumentDTO> loadDocumentsByReference(String reference);
	
	String delete(Long id);
	
	String send(TitularisationDTO dto);
	
	List<TitularisationDTO> getAll();
