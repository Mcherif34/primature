app.controller('collaborateurController', function($scope,$http,$ngBootbox,$location,CRUDService,NotificationService,constants) {
	...
	$scope.baseUrl = "/administration/collaborateur/rest/";
...
app.controller('collaborateurTableController', function($scope,$http) {
		...
		$scope.init = function(idEntite){
			...
			$scope.$parent.table =  $("#collaborateurTable").mytable({
				name:"collaborateurTable",
