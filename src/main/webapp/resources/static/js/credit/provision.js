app.controller('provisionController', function($scope, $http, $ngBootbox, $location, CRUDService, NotificationService, constants) {
	$scope.dto = {};
	$scope.filtre = {};
	$scope.provisionLoyerTable = null;
	$scope.provisionRefacTable = null;
	...
	$scope.baseUrl = "/credit/provision/rest/";
	...
	$scope.refreshList = function() {
		$scope.provisionLoyerTable.ajax.reload();
		$scope.provisionRefacTable.ajax.reload();
		$scope.dto = {};
	};
...
app.controller('provisionLoyerTableController', function($scope,$http) {
	$scope.init = function() {
		var columns = [
			...
			{mDataProp: 'clientCategoryId', "mRender": function(data, type, full) {
				if(full.clientCategoryId == null)
					...
					return '<a href="#" class="flag" title="'+full.clientCategoryName+'"><i class="material-icons" style="color: '+full.clientCategoryColor+'">&#xe153;</i></a>';
				}
			}},
			...
			{mDataProp: 'clientCategoryName'},
			{mDataProp: 'sup60Loyer', "mRender": function(data, type, full) {
				if(full.sup60Loyer != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.sup60Loyer);
				return 0;
			}},
			{mDataProp: 'sup48Loyer', "mRender": function(data, type, full) {
				if(full.sup48Loyer != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.sup48Loyer);
				return 0;
			}},
			{mDataProp: 'sup36Loyer', "mRender": function(data, type, full) {
				if(full.sup36Loyer != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.sup36Loyer);
				return 0;
			}},
			{mDataProp: 'sup24Loyer', "mRender": function(data, type, full) {
				if(full.sup24Loyer != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.sup24Loyer);
				return 0;
			}},
			{mDataProp: 'sup12Loyer', "mRender": function(data, type, full) {
				if(full.sup12Loyer != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.sup12Loyer);
				return 0;
			}},
			{mDataProp: 'inf12Loyer', "mRender": function(data, type, full) {
				if(full.inf12Loyer != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.inf12Loyer);
				return 0;
			}},
		...
		$scope.$parent.provisionLoyerTable = TableManager.init("provisionLoyerTable", $scope.$parent.baseUrl+"list", columns);
		
		$scope.$parent.provisionLoyerTable.on('select', function (e, dt, type, indexes) {
			var rowData = 	$scope.$parent.provisionLoyerTable.rows(indexes).data().toArray();
			var id = null;
			if(rowData.length > 0) {
...
app.controller('provisionRefacTableController', function($scope,$http) {
	$scope.init = function() {
		var columns = [
			{mDataProp: 'id', "visible": false},
			{mDataProp: 'clientCategoryId', "mRender": function(data, type, full) {
			...
			{mDataProp: 'clientCategoryName'},
			{mDataProp: 'sup60Refac', "mRender": function(data, type, full) {
				if(full.sup60Refac != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.sup60Refac);
				return 0;
			}},
			{mDataProp: 'sup48Refac', "mRender": function(data, type, full) {
				if(full.sup48Refac != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.sup48Refac);
				return 0;
			}},
			{mDataProp: 'sup36Refac', "mRender": function(data, type, full) {
				if(full.sup36Refac != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.sup36Refac);
				return 0;
			}},
			{mDataProp: 'sup24Refac', "mRender": function(data, type, full) {
				if(full.sup24Refac != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.sup24Refac);
				return 0;
			}},
			{mDataProp: 'sup12Refac', "mRender": function(data, type, full) {
				if(full.sup12Refac != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.sup12Refac);
				return 0;
			}},
			{mDataProp: 'inf12Refac', "mRender": function(data, type, full) {
				if(full.inf12Refac != null)
					return new Intl.NumberFormat('fr-FR', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(full.inf12Refac);
				return 0;
			}},
			{mDataProp: 'id', "mRender": function(data, type, full) {
				result = '<a href="#" onclick="addClientCategory('+full.id+');" class="btn btn-fw orange" style="min-width: 1rem; padding-left: 8px; padding-right: 8px; padding-top: 3px; padding-bottom: 3px;"><i class="fa fa-inbox"></i></a> <a href="#" onclick="removeClientCategory();" class="btn btn-fw danger" style="min-width: 1rem; padding-left: 8px; padding-right: 8px; padding-top: 3px; padding-bottom: 3px;"><i class="fa fa-times"></i></a>';
		...
		$scope.$parent.provisionRefacTable = TableManager.init("provisionRefacTable", $scope.$parent.baseUrl+"list", columns);
		
		$scope.$parent.provisionRefacTable.on('select', function (e, dt, type, indexes) {
			var rowData = 	$scope.$parent.provisionRefacTable.rows(indexes).data().toArray();
			var id = null;
			if(rowData.length > 0) {
				$scope.$parent.selected = rowData[0];
				id = rowData[0].id;
