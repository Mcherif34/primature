app.controller('calendarController', function($scope, $http, $ngBootbox, $location, CRUDService, NotificationService, constants) {
	$scope.dto = {};
	$scope.filtre = {};
	...
	$scope.init = function() {
		$http.get(context+"/reminder/calendar/rest/getAppointments").success(function(data, status) {   
			$scope.events = data;
		});
